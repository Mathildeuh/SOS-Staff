...
- **Folia-safe** throughout: built against Paper's `GlobalRegionScheduler`/`RegionScheduler`/
  `EntityScheduler`, with no direct Bukkit access from a Discord callback thread.
